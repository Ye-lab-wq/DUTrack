...
cfg.MODEL.TEMPLATE_PROTO = edict()
cfg.MODEL.TEMPLATE_PROTO.ENABLE = False
cfg.MODEL.TEMPLATE_PROTO.KEEP_TOPK = 4
cfg.MODEL.TEMPLATE_PROTO.SPLIT_BETA = 0.35
cfg.MODEL.TEMPLATE_PROTO.REINJECT = True
...
cfg.TRAIN.TRAIN_ONLY_TEMPLATE_PROTO = False
...
cfg.TRAIN.TEMPLATE_PROTO_TARGET_WEIGHT = 0.5
cfg.TRAIN.TEMPLATE_PROTO_SPLIT_WEIGHT = 0.2
cfg.TRAIN.TEMPLATE_PROTO_CTR_WEIGHT = 0.1
cfg.TRAIN.TEMPLATE_PROTO_CTR_TEMP = 0.2
cfg.TRAIN.TEMPLATE_PROTO_CTR_NEG = 8
...
cfg.TEST.EPOCH = 500
cfg.TEST.TEMPLATE_QUALITY_MODE = "prototype"
cfg.TEST.TEMPLATE_GATE_K_IN = 8
cfg.TEST.TEMPLATE_GATE_K_OUT = 8
cfg.TEST.TEMPLATE_GATE_KEEP = 4
cfg.TEST.TEMPLATE_PROTO_BETA = 0.35
cfg.TEST.TEMPLATE_PROTO_ALPHA = 0.6
cfg.TEST.TEMPLATE_PROTO_POS = 0.2
cfg.TEST.TEMPLATE_PROTO_ATTN = 0.2
