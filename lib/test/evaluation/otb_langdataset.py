...
class OTB_LangDataset(BaseDataset):
    ...
    def __init__(self):
        ...
        self.sequence_info_list = self._get_sequence_info_list_test()
    ...
    def _construct_sequence(self, sequence_info):
        ...
        frames = ['{base_path}/{sequence_path}/{frame:0{nz}}.{ext}'.format(base_path=self.img_path, 
        ...
        text_dsp_path = '{}/{}.txt'.format(self.nlp_root, sequence_info['name'])
